...
เปิดใช้งาน login event และ admin event ก่อน go live — เพราะนี่คือ audit trail ของคุณ การเปิดใช้งานหลังเกิดเหตุหมายความว่าคุณสูญเสียข้อมูลที่ต้องการสำหรับการสืบสวนไปแล้ว ตั้งค่าอายุที่เหมาะสม (7–30 วัน) เพื่อควบคุม storage
</Callout>
