...
การล้าง state ในแอปของคุณเพียงอย่างเดียวจะลบ token ออกจากหน่วยความจำเท่านั้น SSO session cookie ของ Keycloak ใน browser ยังคงมีผล จนกว่าจะเรียก keycloak.logout() ผู้ใช้ยังคง login อยู่ทั่วโลกและสามารถกลับเข้าแอปของคุณ (หรือแอปอื่น ๆ ใน realm) โดยไม่ต้องใส่รหัสผ่าน
</Callout>
...
export const quizRefreshLogout = [
  ...
  },
  {
    ...
    options: [
      'เพราะ keycloak-js ไม่สามารถล้าง token cache ภายในของตัวเองได้',
      'เพราะ SSO session cookie ของ Keycloak ใน browser ยังคงมีผลจนกว่าจะเรียก end-session endpoint',
