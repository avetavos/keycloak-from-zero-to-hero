...
Direct Access Grant เหมาะสำหรับ testing script และ CLI tool แต่อย่าใช้ในแอปจริง เพราะเปิดเผย credential ของผู้ใช้ให้กับ client ใช้ Authorization Code + PKCE สำหรับแอป browser และมือถือ
</Callout>
