...
description: 'ภาพรวมของโมดูล Users, Groups & Credentials — เรียนรู้ว่า Keycloak จัดการ identity, รวม user เข้าเป็น group, และบังคับ authentication ผ่าน credential และ required action อย่างไร'
sidebar:
  order: 1
---
