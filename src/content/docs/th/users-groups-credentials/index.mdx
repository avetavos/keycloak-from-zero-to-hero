...
ใน Keycloak นั้น identity (user) แยกออกจาก authorization (role และ group) — คุณจัดการสองส่วนนี้แยกกันได้ บัญชี user จะไม่มี permission ใด ๆ จนกว่าคุณจะแนบ role หรือการเป็นสมาชิก group ให้
</Callout>
