...
ตั้งค่า access token ให้มีอายุสั้น (1–5 นาที) และพึ่ง refresh token เพื่อรักษา session หาก access token ถูกดักจับหรือหลุดออกไป จะหมดอายุก่อนที่ผู้โจมตีจะใช้ประโยชน์ได้มาก
</Callout>
...
>
> **การ revoke session รายอุปกรณ์ตามแบบที่แพลตฟอร์ม streaming รายใหญ่ใช้** — ใช้ access token อายุสั้นร่วมกับการ revoke refresh token เฉพาะ device เมื่อผู้ใช้กด "sign out this device" ทำให้ session บนทีวีหรือมือถือเครื่องหนึ่งถูกตัดออกได้เกือบทันที โดยไม่กระทบ session บนอุปกรณ์อื่นเลย
